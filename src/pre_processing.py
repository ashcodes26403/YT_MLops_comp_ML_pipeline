...
logger = logging.getLogger('pre_processing') #making a logger object
...
def main():
    "Main function to load the data, preprocess it, and save it."
    ...
    try:
        ...
        train_df_preprocessed.to_csv(os.path.join(save_path, 'train_processed.csv'), index=False)
        test_df_preprocessed.to_csv(os.path.join(save_path, 'test_processed.csv'), index=False)
